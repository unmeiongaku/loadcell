...
uint8_t eeprom_write_type_float(uint16_t page_start,uint16_t offset, float data){
...
uint8_t eeprom_write_type_int(uint16_t page_start,uint16_t offset, int data){
	uint8_t buffer[4] = {0.0};
...
uint8_t eeprom_read_type_int(uint16_t page_start,uint16_t offset, int *data){
	uint8_t buffer[4] = {0.0};
	for(uint8_t i =0; i<sizeof(data);i++){
        buffer[i] = EEPROM.read(WEIGHT_CALIBRATION_ADDR + i);
    }
...
uint8_t eeprom_write_type_1_byte_int8(uint16_t page_start,uint16_t offset, int8_t data){
	uint8_t buffer[1] = {0.0};
...
uint8_t eeprom_read_type_1_byte_int8(uint16_t page_start,uint16_t offset, int8_t *data){
	uint8_t buffer[1] = {0.0};
	for(uint8_t i =0; i<sizeof(data);i++){
        buffer[i] = EEPROM.read(WEIGHT_CALIBRATION_ADDR + i);
    }
...
uint8_t eeprom_write_type_2_bytes_uint16(uint16_t page_start,uint16_t offset, uint16_t data){
...
uint8_t eeprom_read_type_2_bytes_uint16(uint16_t page_start,uint16_t offset, uint16_t *data){
	uint8_t buffer[2] = {0.0};
	for(uint8_t i =0; i<sizeof(data);i++){
        buffer[i] = EEPROM.read(WEIGHT_CALIBRATION_ADDR + i);
    }
...
uint8_t eeprom_write_type_2_bytes_int16(uint16_t page_start,uint16_t offset, int16_t data){
	uint8_t buffer[2] = {0.0};
...
uint8_t eeprom_read_type_2_bytes_int16(uint16_t page_start,uint16_t offset, int16_t *data){
	uint8_t buffer[2] = {0.0};
	for(uint8_t i =0; i<sizeof(data);i++){
